...
from main.api_http_common import format_numbers10, format_numbers_strong, format_numbers, format_numbers4, json_false500, json_true
...
def process_order(AccountBuyer, ComisBuy, AccumSum, AccumSumToSell,  item, Order, TradePair, ComisSell ):
        ...
        if item.sum1 <= AccumSum :  
            ...
            try:
                ...
                system_notify_async(order_description_buy(TransSum,  NotifySum,  Order, item, TradePair), AccountBuyer.user.id)
