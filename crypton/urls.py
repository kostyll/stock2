...
urlpatterns = patterns('',
                       ...
                       url(r'^profile/common_secure_page/private_key$', 'main.profile.page_private_key',
                           name='page_private_key'),
                       ...
                       url(r'^profile/setup_g2a_verify/([\w]+)$', 'main.profile.setup_g2a_verify',
                           name='setup_g2a_verify'),
                       ...
                       url(r'^reset_pwd_action/([\w]+)$', 'main.forgot_password_views.reset_pwd_action',
                           name='reset_pwd_action'),
                       url(r'^reset_pwd/([\w]+)$', 'main.forgot_password_views.reset_pwd', name='reset_pwd'),
                       url(r'^reset_link_no_found$', 'main.forgot_password_views.reset_link_no_found',
                           name='reset_link_no_found'),
                       ...
                       url(r'^finance/liqpay/start/([\w\.]+)', 'main.finance.liqpay_start_pay',
                           name='liqpay_start_pay'),
                       ...
                       url(r'^finance/p24/hui_hui_hui/([\w]+)', 'main.finance.p24_call_back_url',
                           name='p24_call_back_url'),

                       url(r'^finance/perfectmoney/deposit/([\w]+)/([\w\.]+)', 'main.finance_perfect.perfect_deposit',
                           name='perfect_deposit'),
                       url(r'^finance/perfectmoney/start/([\w]+)/([\w\.]+)', 'main.finance_perfect.perfect_start_pay',
                           name='perfect_start_pay'),
                       url(r'^finance/perfectmoney/hui_hui_hui/([\w]+)/([\w\.]+)',
                           'main.finance_perfect.perfect_call_back_url', name='perfect_call_back_url'),
                       url(r'^finance/perfectmoney/hui_hui_hui_hui/([\w]+)',
                           'main.finance_perfect.perfect_call_back_url_fail', name='perfect_call_back_url_fail'),
                       ...
                       url(r'^finance/common_confirm_page/([\w]+)', 'main.finance.common_confirm_page',
                           name='common_confirm_page'),

                       url(r'^finance/liqpay/hui_hui_hui/([\w]+)', 'main.finance.liqpay_call_back_url',
                           name='call_back_url'),
                       ...
                       url(r'^finance/perfect_transfer_withdraw/([\w]+)/([\w\.]+)',
                           'main.finance_perfect.perfect_transfer_withdraw',
                       ...
                       url(r'^finance/emoney_transfer_withdraw_submit_perfect',
                           'main.finance_perfect.perfect_transfer_withdraw_submit',
